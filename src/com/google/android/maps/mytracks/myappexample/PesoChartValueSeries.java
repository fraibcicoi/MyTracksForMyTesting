 ...
 */
public class PesoChartValueSeries {
  ...
  private int maxMarkerValue = interval * PesoChartView.Y_AXIS_INTERVALS;
   ...
   */
  public PesoChartValueSeries(Context context, int absoluteMin, int absoluteMax, int[] intervalValues,
    ...
    titlePaint.setTextSize(PesoChartView.MEDIUM_TEXT_SIZE * scale);
    titlePaint.setTextAlign(Align.CENTER);

    markerPaint = new Paint(strokePaint);
    markerPaint.setTextSize(PesoChartView.SMALL_TEXT_SIZE * scale);
  ...
  public void updateDimension() {
    ...
    maxMarkerValue = minMarkerValue + interval * PesoChartView.Y_AXIS_INTERVALS;
  }
  ...
  private int getInterval(double min, double max) {
    for (int i = 0; i < intervalValues.length; i++) {
      ...
      double targetInterval = (max - minValue) / PesoChartView.Y_AXIS_INTERVALS;
